    ...
    <>
      <div className="trash-actions">
        <button 
          ...
          className="custom_button_long danger"
      ...
      <div className="data-list">
        {currentNews.length === 0 ? (
          ...
          <div key={news.newsID} className="data-item deleted">
            <h2>{news.title}</h2>
            ...
            <div className="news-meta">
              ...
              {news.files?.length > 0 && (
                <NewsGallery 
                  files={news.files}
                  onImageClick={() => handleOpenLightbox(news, 0)}
                />
              )}
            </div>
            ...
            <div className="moderation-actions">
              <button 
                ...
                className="custom_button_short restore"
              >
                Восстановить с правками
              </button>
              <button 
                onClick={() => purgeNews(news.newsID)}
                className="custom_button_short danger"
              >
                Удалить
              </button>
            </div>
